...
FProceduralAnimationEditorViewportClient::FProceduralAnimationEditorViewportClient(const TSharedRef<SProceduralAnimationEditorViewport>& InProceduralAnimationEditorViewport, const TSharedRef<FAdvancedPreviewScene>& InPreviewScene) 
: FEditorViewportClient(nullptr, &InPreviewScene.Get(), StaticCastSharedRef<SEditorViewport>(InProceduralAnimationEditorViewport))
, ViewportPtr(InProceduralAnimationEditorViewport)
{
...
void FProceduralAnimationEditorViewportClient::Tick(float DeltaSeconds)
{
...
void FProceduralAnimationEditorViewportClient::TakeSingleShot()
{
	//Enable green mask
	EngineShowFlags.SetHighResScreenshotMask(true);

	//set the size of the screenshot
	GScreenshotResolutionX = ProceduralAnimationEditorOptions->ScreenshotXSize;
	GScreenshotResolutionY = ProceduralAnimationEditorOptions->ScreenshotYSize;
	...
	auto ModulePtr = FModuleManager::LoadModulePtr<FProceduralAnimationEditorModule>(FName("ProceduralAnimationEditor"));
	if (ModulePtr)
	{
...
void FProceduralAnimationEditorViewportClient::ResetScene()
{
	//PreviewScene = NULL;
}

void FProceduralAnimationEditorViewportClient::SetMesh(class UStaticMesh* inMesh, bool bTakeShot)
{
...
void FProceduralAnimationEditorViewportClient::SetSkelMesh(class USkeletalMesh* inMesh, class UAnimationAsset* AnimAsset /*= NULL*/, bool bTakeShot /*= false*/)
{
	if (inMesh || AnimAsset)
	{
...
void FProceduralAnimationEditorViewportClient::SetMaterial(UMaterialInterface* inMaterial, bool bTakeShot /*= false*/)
{
...
void FProceduralAnimationEditorViewportClient::SetComponentVisibility(UActorComponent* ComponentToActivate, EScreenshotType Type)
{
...
FString FProceduralAnimationEditorViewportClient::GetAssetName()
{
