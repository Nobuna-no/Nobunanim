...
class FProceduralAnimationEditorModule : public IModuleInterface
{
public:
	...
	*/
	...
	TSharedPtr<class SProceduralAnimationEditorViewport> ViewportPtr;
	...
	//ProceduralAnimationEditor options for the screenshots
