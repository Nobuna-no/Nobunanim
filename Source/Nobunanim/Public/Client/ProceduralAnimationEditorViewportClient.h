...
class PROCEDURALANIMATIONEDITOR_API FProceduralAnimationEditorViewportClient : public FEditorViewportClient
{
...
public:
	...
	TWeakPtr<class SProceduralAnimationEditorViewport> ViewportPtr;

	//Constructor and destructor
	FProceduralAnimationEditorViewportClient(const TSharedRef<SProceduralAnimationEditorViewport>& InProceduralAnimationEditorViewport, const TSharedRef<FAdvancedPreviewScene>& InPreviewScene);
	...
	//Options file
	class UProceduralAnimationEditorOptions* ProceduralAnimationEditorOptions;
